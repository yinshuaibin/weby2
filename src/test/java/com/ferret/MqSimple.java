 ...
 */
public class MqSimple implements MqttCallback {
    ...
    public static void main(String[] args) {
        ...
        try {
            ...
            MqSimple sampleClient = new MqSimple(url, clientId, cleanSession, quietMode,userName,password);
     ...
     */
    public MqSimple(String brokerUrl, String clientId, boolean cleanSession, boolean quietMode, String userName, String password) throws MqttException {
